...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240202080257_AddCarModelToDB")]
    partial class AddCarModelToDB
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Cars.Car", b =>
                {
            ...
            modelBuilder.Entity("Domain.Models.Cars.Car", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Engines.Engine", "Engine")
                        .WithMany()
                        .HasForeignKey("EngineId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Models.Gearboxes.Gearbox", "Gearbox")
                        .WithMany()
                        .HasForeignKey("GearboxId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Models.Seats.Seat", "Seat")
                        .WithMany()
                        .HasForeignKey("SeatId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Models.Tires.Tire", "Tire")
                        .WithMany()
