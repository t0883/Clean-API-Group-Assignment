...
namespace Application.Commands.Engines.UpdateEngine
{
    public class UpdateEngineCommandHandler : IRequestHandler<UpdateEngineCommand, Engine>
    {
        ...
        {
            Engine engineToUpdate = new Engine { EngineId = request.EngineId, EngineName = request.EngineName, EngineFuel = request.EngineFuel, HorsePower = request.HorsePower, Brand = request.Brand };
